...
<c:choose>
			...
			<div class="card">
				<div class="row">
					<div class="col-md-5 wrapthumbnail">
						<a href="/yamsuleng/store/detail?id=${store.ID}">
						<!-- 썸네일자리  -->
	...
	<div class="card-columns listrecent">
		...
		<!-- begin post -->
		<div class="card">
			<a href="/yamsuleng/post/detail?postID=${post.POSTID}">
			...
			<div class="card-block">
				...
				<div class="metafooter">
					<div class="wrapfooter">
						...
						<a href="/yamsuleng/userPage/userTemplate?pageOwnerId=${post.ACCID}"><img class="author-thumb" src="https://www.gravatar.com/avatar/e56154546cf4be74e393c62d1ae9f9d4?s=250&amp;d=mm&amp;r=x" alt="Sal"></a>
						</span>
						<span class="author-meta">
						<span class="post-name"><a href="/yamsuleng/userPage/userTemplate?pageOwnerId=${post.ACCID}">${post.USER_ID}</a></span><br/>
						<span class="post-name">${post.STAR_RATE}</span><br/>
