				...
				<form method="post" id="accUpFrm" >
						...
						<div class="row">
							<div class="col-md-12">
					            ...
					            <input type="text" name="name" id="name" value="${accInfo.name}" class="form-control" readonly>
					            <br>
			      				</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group d-flex align-items-center">
				      			...
				      			<input type="text" name="user_id" id="user_id" value="${accInfo.user_id}"class="form-control" readonly>
			      				<br>
			      				</div>
							</div>
