		...
		<ul class="navbar-nav ml-auto">
	 	...
	 	<c:choose>
			...
			<c:when test="${sessionScope.sessionID != null}"> 
				...
				<li class="nav-item">
					<a class="nav-link" href="/yamsuleng/post/write">리뷰쓰기</a>
				</li> 
				<li class="nav-item">
					<a class="nav-link" href="/yamsuleng/userPage/userTemplate?pageOwnerId=${sessionScope.sessionID}">마이페이지</a>
				</li>
			...
			<li class="nav-item">
				<a class="nav-link" href="/yamsuleng/store/list?searchKeyWord=">맛집리스트</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/yamsuleng/post/list?searchKeyWord=">리뷰광장</a>
			</li>
